          ...
          <div className="w-[50%] h-max flex justify-center items-center mt-4 bg">
            <div className="space-y-3">
              <div className="flex justify-center items-center">
                <h1 className="font-open-sans tracking-wider text-md font-bold text-center p-2 md:text-xl text-[#17408b] mb-4">
              ...
              <div className="flex justify-center items-center space-x-4 text-sm">
                <button class="w-[100px] h-[40px]  text-gray-900 rounded-lg group bg-gradient-to-br p-[2px] from-[#17408b] to-[#7dbff8] hover:text-white">
